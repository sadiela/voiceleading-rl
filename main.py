...
if __name__ == "__main__":
    ...
    voicing_epoch_rewards = voicing_agent.trainModel(chord_progressions, num_epochs=5000)
    ...
    ex_prog = [1,2,5,1,-1]
    voicing_agent.evalAgent(ex_prog, 5, synth=True, fname='presentation_example')
